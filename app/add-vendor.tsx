...
import { createVendor } from '../src/services/vendorService';
...
export default function AddVendor() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            Alert.alert(t('success'), t('vendor_created_successfully', 'Vendor created successfully'), [
                { text: "OK", onPress: () => router.back() }
            ]);
        } catch (error: any) {
            console.error("Submission error:", error);
            Alert.alert(t('error'), error.response?.data?.message || t('failed_to_create_vendor', 'Failed to create vendor'));
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <View style={styles.container}>
            <Stack.Screen options={{ title: t('add_vendor', 'Add Vendor') }} />
                ...
                >
                    {loading ? (
                        ...
                        <>
                            ...
                            <Text style={styles.submitButtonText}>{t('save_vendor', 'Save Vendor')}</Text>
                        </>
                    )}
                </TouchableOpacity>
            </View>
