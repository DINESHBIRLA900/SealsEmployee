...
export default function AddSupplier() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            Alert.alert(t('success'), t('supplier_created_successfully', 'Supplier created successfully'), [
                { text: "OK", onPress: () => router.back() }
            ]);
        } catch (error: any) {
            console.error("Submission error:", error);
            Alert.alert(t('error'), error.response?.data?.message || t('failed_to_create_supplier', 'Failed to create supplier'));
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <View style={styles.container}>
            <Stack.Screen options={{ title: t('add_supplier', 'Add Supplier') }} />
                ...
                >
                    {loading ? (
                        ...
                        <>
                            ...
                            <Text style={styles.submitButtonText}>{t('save_supplier', 'Save Supplier')}</Text>
                        </>
                    )}
                </TouchableOpacity>
            </View>
